...
var file_executor_proto_rawDesc = []byte{
	...
	0x2d, 0x73, 0x64, 0x6b, 0x2d, 0x67, 0x6f, 0x2f, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x73, 0x2f,
...
var file_executor_proto_goTypes = []interface{}{
	...
	(*proto.Block)(nil),        // 2: blockchain.Block
...
type ExecutorServiceClient interface {
	...
	Exec(ctx context.Context, in *proto.Block, opts ...grpc.CallOption) (*proto.HashResponse, error)
...
func (c *executorServiceClient) Exec(ctx context.Context, in *proto.Block, opts ...grpc.CallOption) (*proto.HashResponse, error) {
...
type ExecutorServiceServer interface {
	// exec a block return executed_block_hash
	Exec(context.Context, *proto.Block) (*proto.HashResponse, error)
...
func (*UnimplementedExecutorServiceServer) Exec(context.Context, *proto.Block) (*proto.HashResponse, error) {
...
func _ExecutorService_Exec_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExecutorServiceServer).Exec(ctx, req.(*proto.Block))
	}
